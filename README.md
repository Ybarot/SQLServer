...
**This script requires you to provide login with view server state and ALTER ANY EVENT SESSION. It will retun 1 if any of the bellow Enterprise Edition features are being used. **
